...
def main():
    ...
    for issue in (
        ...
        # ----------------------------------------------------
        # REGLE METIER GIL - DEMANDE D'ARRIMAGE
        #
        # La JQL Jira reste volontairement large :
        #
        #   summary ~ "Arrimage"
        #
        # Jira n'indexe pas de manière fiable les crochets.
        # Un Epic n'est donc retenu comme demande d'arrimage
        # que si son SUMMARY contient un bloc [...]
        # contenant le mot Arrimage.
        #
        # Acceptés :
        #   [Arrimage] - Acquisition
        #   [Arrimage BCEF] - ISS
        #   Flux - [Arrimage] - ACQ
        #   Demande - [BCEF Arrimage] - Onboarding
        #
        # Rejetés :
        #   TEMPLATE ARRIMAGE
        #   Demande Arrimage sans crochets
        #   [TEST] Arrimage
        #   Flux Arrimage [TEST]
        # ----------------------------------------------------
